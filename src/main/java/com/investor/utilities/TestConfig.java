...
public class TestConfig{
	...
	public static String from = "usmantalha09@gmail.com";
	public static String password = "Selenium@123";
	public static String[] to ={"usmantalha09@gmail.com"};
	...
	public static String dbUserName="sal"; 
	public static String dbPassword="$ql$!!123"; 
	
	
	//MYSQL DATABASE DETAILS
	public static String mysqldriver="com.mysql.jdbc.Driver";
	public static String mysqluserName = "root";
	public static String mysqlpassword = "seleniumSQL";
